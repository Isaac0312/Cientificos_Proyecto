...
public class ProyectoController {
	...
	public Proyecto proyecto_x_ID(@PathVariable(name="id") String id) {
		
		Proyecto proyecto_x_id= new Proyecto();
		
		proyecto_x_id=proyectoServiceImpl.proyecto_x_id(id);
	...
	public Proyecto actualizarProyecto(@PathVariable(name="id") String id,@RequestBody Proyecto proyecto) {
		...
		proyecto_seleccionado= proyectoServiceImpl.proyecto_x_id(id);
